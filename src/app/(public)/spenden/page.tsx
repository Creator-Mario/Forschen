    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="bg-white rounded-xl shadow-md p-8">
        ...
        <p className="text-gray-600 text-sm mb-8 text-center">
          Geben Sie die E-Mail-Adresse in Ihrer PayPal-App ein.
        </p>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600">
            ...
            <li>Wählen Sie &bdquo;Geld senden&ldquo; und geben Sie die obige E-Mail-Adresse ein</li>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-amber-800">
          <span className="font-semibold">Hinweis:</span> Die E-Mail-Adresse funktioniert mit PayPal in allen Ländern –
