...
export default function NeueThesePage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setError('');
    setLoading(true);
    const res = await fetch('/api/thesen', {
      method: 'POST',
  ...
  return (
    <ProtectedRoute>
      <div className="max-w-2xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-blue-800 mb-2">These verfassen</h1>
        <p className="text-gray-500 mb-8">Deine These wird nach der Einreichung moderiert.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Kurze, prägnante Aussage"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Entfalte deine These ausführlich und begründe sie theologisch…"
              />
            </div>
            ...
            >
              {loading ? 'Wird eingereicht…' : 'These einreichen'}
            </button>
          </form>
        </div>
      </div>
